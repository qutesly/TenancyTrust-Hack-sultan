    ...
    <div className=" w-full flex flex-col font-josefin">
      ...
      <div className="flex flex-col">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-[36px] flex items-center gap-2 underline">.50 Reviews</h2>
        </div>
      ...
      <Modal
        ...
        className="relative flex flex-col w-[1200px] bg-[#D9D9D9] rounded-lg font-josefin px-4 md:px-8 lg:px-20 mx-4 mt-80 scrollbar-hide"
      >
        <div className="absolute -top-6 left-1/2 right-1/2 flex items-center justify-center rounded-full w-[20px] md:w-[30px] h-[20px] md:h-[30px] bg-black text-black text-[40px] font-light hoverEffect ">
        ...
        <p className="text-black font-josefin text-[12px] md:text-[20px] text-center mt-4">
          ...
          <span className="text-[#9747FF]">Tenancytrust.ng</span>
        </p>
      </Modal>
    </div>
  );
